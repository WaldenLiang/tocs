<template>
  <div>
    <q-btn-dropdown icon="format_align_center"
                    ...
                    flat>
      <q-list>
        <q-item v-for="(item, index) in alignments"
                :key="index"
...
export default {
  ...
  computed: {
    alignments () {
      return [
        {
          label: this.$t('editor.left'),
          value: 'left',
          command: this.commands.alignment
        },
        {
          label: this.$t('editor.center'),
          value: 'center',
          command: this.commands.alignment
        },
        {
          label: this.$t('editor.right'),
          value: 'right',
          command: this.commands.alignment
        },
        {
          label: this.$t('editor.justify'),
          value: 'justify',
          command: this.commands.alignment
        }
      ]
