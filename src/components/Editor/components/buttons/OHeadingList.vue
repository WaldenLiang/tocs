<template>
  <q-list class="o-heading-list">
    ...
    <q-separator />
    <q-item v-for="(item, index) in headings"
            :key="index"
...
export default {
  ...
  computed: {
    headings () {
      return [
        {
          label: this.$t('editor.heading1'),
          value: 1
        },
        {
          label: this.$t('editor.heading2'),
          value: 2
        },
        {
          label: this.$t('editor.heading3'),
          value: 3
        },
        {
          label: this.$t('editor.heading4'),
          value: 4
        },
        {
          label: this.$t('editor.heading5'),
          value: 5
        }
      ]
    }
