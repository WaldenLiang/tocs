<template>
  <o-block-card class="o-diagram"
    ...
    <template slot="toolbar-right">
      <q-btn-dropdown :label="$t('label.template')"
                      ...
                      v-if="view.editable">
        <q-list>
          <q-item v-for="(item, index) of mermaidDiagrams"
                  :key="index"
      ...
      <q-btn-dropdown dropdown-icon="more_vert"
        ...
        <q-list style="min-width: 120px;">
          <o-common-item icon="delete"
                         :label="$t('label.remove')"
                         @click.native="onDelete" />
          <o-common-item icon="help_outline"
                         :label="$t('label.help')"
                         @click.native="onHelp" />
        </q-list>
      </q-btn-dropdown>
...
export default {
  ...
  computed: {
    ...
    mermaidDiagrams () {
      return [
        {
          label: this.$t('diagram.flow'),
          value: 'flow'
        },
        {
          label: this.$t('diagram.sequence'),
          value: 'sequence'
        },
        {
          label: this.$t('diagram.class'),
          value: 'class'
        },
        {
          label: this.$t('diagram.state'),
          value: 'state'
        },
        {
          label: this.$t('diagram.gantt'),
          value: 'gantt'
        }
      ]
    }
