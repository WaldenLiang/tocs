<template>
  <o-block-card class="o-embed"
      ...
      <q-input v-model="originalLink"
        ...
        <template v-slot:prepend>
          <div class="row items-center">
            ...
            <q-icon :name="service.icon || 'apps'"
                    :color="service.color"
                    v-else />
            <q-tooltip anchor="top middle"
                       self="bottom middle">{{$t(`embed.${service.value}`)}}
            </q-tooltip>
          </div>
        </template>
      </q-input>
    ...
    <template slot="toolbar-right">
      ...
      <q-btn-dropdown dropdown-icon="more_vert"
        ...
        <span class="text-blue"
              slot="label">{{$t('label.submit')}}</span>
        <q-list style="min-width: 120px;">
          <o-common-item icon="settings"
    ...
    <div class="o-embed-content"
      ...
      <div class="row justify-center items-center iframe"
           v-show="loading">
