  ...
  <span class="o-image-view"
    ...
    <span class="image-container"
      ...
      <div v-if="view.editable"
           ...
           class="image-resizer">
        <span v-for="(item, index) in resizeDirections"
              :key="index"
      ...
      <div class="col-auto actions">
        <q-btn color="blue"
          ...
          <q-tooltip anchor="top middle"
                     self="bottom middle">{{$t('editor.toggleFullscreen')}}</q-tooltip>
        </q-btn>
        <q-btn color="blue"
               icon="settings"
               flat
               v-if="view.editable">
          <q-tooltip anchor="top middle"
                     self="bottom middle">{{$t('image.preferences')}}</q-tooltip>
          <q-menu ref="imgRef"
                  anchor="top right"
                  self="top left"
            ...
            <section class="q-px-md q-pb-sm">
              <div class="row justify-between items-center text-bold q-py-sm">
                ...
                <div><q-btn icon="close"
                            size="0.7rem"
                            flat
                            dense
                            @click="$refs.imgRef.hide()" /></div>
              </div>
              <q-separator />
              <div class="row col-12 items-start q-py-md">
                <q-input v-model="imgOption.width"
                         type="number"
                         debounce="500"
                         standout
                         :hint="$t('image.width')"
                ...
                <q-input v-model="imgOption.height"
                         type="number"
                         debounce="500"
                         standout
                         :hint="$t('image.height')"
              ...
              <div class="row col-12 items-center q-py-sm">
                {{$t('image.caption')}}
                <q-input v-model="imgOption.caption"
                         debounce="500"
                         class="col-12"
                         standout
                         clearable
